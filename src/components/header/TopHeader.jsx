          ...
          <div className="d-flex align-items-center">
            ...
            <div className="nav-item dropdown mx-2">
              ...
              <button className="modeswitch" id="bd-theme" type="button" aria-expanded="false" data-bs-toggle="dropdown" data-bs-display="static">
                <svg className="theme-icon-active"><use></use></svg>
              </button>
            ...
            <ul className="nav">
              <li className="nav-item">
                <a className="nav-link px-2 fs-5"><i className="fab fa-facebook-square"></i></a>
              </li>
              <li className="nav-item">
                <a className="nav-link px-2 fs-5"><i className="fab fa-twitter-square"></i></a>
              </li>
              <li className="nav-item">
                <a className="nav-link px-2 fs-5"><i className="fab fa-linkedin"></i></a>
              </li>
              <li className="nav-item">
                <a className="nav-link px-2 fs-5"><i className="fab fa-youtube-square"></i></a>
              </li>
              <li className="nav-item">
                <a className="nav-link ps-2 pe-0 fs-5"><i className="fab fa-vimeo"></i></a>
              </li>
            </ul>
          </div>
        </div>
